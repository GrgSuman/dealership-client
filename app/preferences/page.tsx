            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                  ...
                  <button
                    key={item.type}
                    className={`border rounded-lg p-4 text-left transition-colors ${selectedVehicleTypes.includes(item.type)
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    key={range}
                    className={`border rounded-lg p-3 text-center transition-colors ${selectedBudget === range
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    key={feature.name}
                    className={`border rounded-lg p-3 flex items-center transition-colors ${selectedFeatures.includes(feature.name)
                      ? "border-green-500 bg-green-50"
                      : "border-gray-200 hover:border-gray-300"
                      }`}
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    key={use}
                    className={`border rounded-lg p-3 text-center transition-colors ${selectedUsage.includes(use)
                      ? "border-green-500 bg-green-50 text-green-700"
                      : "border-gray-200 hover:border-gray-300 text-gray-700"
                      }`}
            ...
            <section className="mb-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    key={priority}
                    className={`border rounded-lg p-3 text-center transition-colors ${selectedPriorities.includes(priority)
                      ? "border-green-500 bg-green-50 text-green-700"
                      : "border-gray-200 hover:border-gray-300 text-gray-700"
